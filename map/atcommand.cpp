...
ACMD_FUNC(go)
{
	...
	const struct {
		...
		{ MAP_AYOTHAYA,    217, 102 }, // 18=Ayothaya
...
//		{ MAP_GRAMPS,        32, 21 }, // 37 EDEN/GRAMPS (BG)
//		{ MAP_INVEK,       146, 171 }, // 38 INVEK/COMÉRCIO (BG)
//		{ MAP_BG,            32, 32 }, // 39 SOUL ARENA (BG)
	};
...
//		town = 36;
//	} else if (strncmp(map_name, "moc_para01", 2) == 0) {
//		town = 37;
//	} else if (strncmp(map_name, "invek", 2) == 0) {
//		town = 38;
//	} else if (strncmp(map_name, "soularena", 2) == 0) {
//		town = 39;
	}
